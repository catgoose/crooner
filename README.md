...
- Don't let some fake link log you out—the logout route is **POST** only. Use a form with `method="post"` and `action="/logout"` (or a button that submits it) for your logout button.
